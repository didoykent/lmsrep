						...
						<v-expansion-panel v-for="(item,i) in Tutors" :key="i">
							...
							<v-expansion-panel-content>
								<v-row>
									...
									<v-icon class="mx-2" color="#1976d2" medium @click = "openChat(item)">chat</v-icon>
  ...
  <div class="float-right button-container" >
	...
	<div class = "features">
		...
		<v-dialog v-model="chatDialog" max-width="1100"  >
			...
			<v-card style="max-height: 500px; box-shadow:none; border-radius:0px; overflow-y: hidden;">
	          ...
	          >
	          <v-list flat 	:color = "message.sender_conn_id !== selectedTutor ? 'primary' : ''">
	        ...
	        <span class="white--text headline">CJ</span>
	          ...
	          <v-list-item-content>
	            <div class="white--text">{{message.message}}  </div>
	          </v-list-item-content>
	        </v-list-item>
...
v-model = "message"
		 ...
		 @click:append="sendMessage()" @keyup.enter ="sendMessage()"></v-textarea>
